...
const bt// --- 1. CONFIGURACIÓN DEL SISTEMA DE LOGIN ---
const URL_API = "https://script.google.com/macros/s/AKfycbzifh_OFapV6c7LAbHuN8_nhgXp04eg6PmnTzTeyQ3hfZ4d8sYhghDd69-R1DkDcnac/exec"; 
...
btnOptEditable.addEventListener('click', function() {
    ...
    modalInventario.style.display = "none"; // Cierra el cuadro
});
...
function cerrarVisor() {
    ...
    iframeInventario.src = ""; // Limpia el iframe al cerrar para optimizar el navegador
...
function cerrarPlan() {
    ...
    window.scrollTo({ top: 0, behavior: 'smooth' });
}nIngresar = document.getElementById('btnIngresar');
const mensajeError = document.getElementById('mensajeError');
